<script>
    ...
    let cards = [
    {genre:"THRILLER", font:"Joane Stencil Regular // Sensaway", shadowColor:"#163d76",color:"#fefffe", imageUrl:"src/assets/movies//Burning.jpg"},
    {genre:"SCI-FI", font:"'Lato', sans-serif", color:"#596871",shadowColor:"#7899b3", imageUrl:"src/assets/movies/Arrival.jpg"},  
    {genre:"HORROR", font:"kepler-std-semicondensed-dis, serif", shadowColor:"#9c2436",color:"#fbedda", imageUrl:"src/assets/movies/Raw.jpg"},
    {genre:"Drama", font:"Helvetica", color:"#f2f3ec",shadowColor:"#9d2324", imageUrl:"src/assets/movies/Aftersun.jpg"},
    {genre:"ACTION", font:"Arial", color:"#c9bd99 ",shadowColor:"#745e43", imageUrl:"src/assets/movies/Madmax.jpg"}
  ]
</script>
...
<section>
    <h2>
        (In construction) Detail of movie 
    </h2>
    <div class="container">
        <div class="detail-img center">
            <div class="cardo"
                ...
                style:background-image={"url("+cards[0].imageUrl+")"}
                style:font-family={cards[0].font}
                style:--color={cards[0].shadowColor}
                >
        ...
        <div class="movie-detail"> 
            <p> <span class="label"> Title :</span> Burning </p>
        
            <p> <span class="label"> Film director :</span> Lee Chang-dong</p>
            <p> <span class="label"> Genres :</span> Thriller </p>
            <p> <span class="label"> Description :</span> </p>
            <p> Jong-su bumps into a girl who used to live in the same neighborhood,
                who asks him to look after her cat while she's on a trip to Africa.
                When back, she introduces Ben, a mysterious guy she met there, who
